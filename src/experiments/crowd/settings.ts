...
export const PRESETS: { label: string; hint: string; settings: Settings }[] = [
  ...
  {
    label: "catch me",
    hint: "The market, and somebody in red I am trying to keep up with — they run when I get close and wait when I fall behind. The red head looks like the subject for a moment. It is not: the subject is whoever is doing the chasing.",
    settings: {
      density: 48,
      stream: 0.22,
      against: 0.5,
