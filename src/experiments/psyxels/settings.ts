...
export const PRESETS: { label: string; hint: string; settings: Settings }[] = [
  ...
  {
    label: "luna",
    hint: "The word as a hole again, and everything around it held: one grain everywhere rather than a range of them, every psyx keeping the mark and the colour it was dealt, and nothing left moving but the breath.",
    settings: {
      seed: 639953,
      subject: "Luna",
      face: "roman",
